...
const S = {
  ...
  offline: { background: "var(--bg-muted)", border: "1px solid var(--warning-bg)", color: "var(--warning-fg)" },
  pending: { background: "var(--primary-tint)", border: "1px solid var(--primary-tint)", color: "var(--primary-hover)" },
  spacer: { flex: 1 },
  btn: {
    border: "none",
